...
export default class SubscriptionHistory extends JsonMember {
    ...
    constructor(subscriptionToken?: string, expiryDateTime?: Date | null, expiredDateTime?: Date | null, createdDateTime?: Date | null, activationDateTime?: Date | null, cancellationDateTime?: Date | null, subscriptionStatus?: string, clientReference?: string);
