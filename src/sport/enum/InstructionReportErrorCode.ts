...
export default class InstructionReportErrorCode extends Enum {
    ...
    public setValue(value: string): void {
        if (value) {
            if (value !== 'INVALID_BET_SIZE' && value !== 'INVALID_RUNNER' && value !== 'BET_TAKEN_OR_LAPSED' && value !== 'BET_IN_PROGRESS' && value !== 'RUNNER_REMOVED' && value !== 'MARKET_NOT_OPEN_FOR_BETTING' && value !== 'LOSS_LIMIT_EXCEEDED' && value !== 'MARKET_NOT_OPEN_FOR_BSP_BETTING' && value !== 'INVALID_PRICE_EDIT' && value !== 'INVALID_ODDS' && value !== 'INSUFFICIENT_FUNDS' && value !== 'INVALID_PERSISTENCE_TYPE' && value !== 'ERROR_IN_MATCHER' && value !== 'INVALID_BACK_LAY_COMBINATION' && value !== 'ERROR_IN_ORDER' && value !== 'INVALID_BID_TYPE' && value !== 'INVALID_BET_ID' && value !== 'CANCELLED_NOT_PLACED' && value !== 'RELATED_ACTION_FAILED' && value !== 'NO_ACTION_REQUIRED' && value !== 'INVALID_MIN_FILL_SIZE' && value !== 'INVALID_CUSTOMER_ORDER_REF' && value !== 'TIME_IN_FORCE_CONFLICT' && value !== 'UNEXPECTED_PERSISTENCE_TYPE' && value !== 'INVALID_ORDER_TYPE' && value !== 'UNEXPECTED_MIN_FILL_SIZE' && value !== 'INVALID_CUSTOMER_STRATEGY_REF' && value !== 'BET_LAPSED_PRICE_IMPROVEMENT_TOO_LARGE') {
