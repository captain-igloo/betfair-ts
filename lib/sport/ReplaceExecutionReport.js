...
const ReplaceInstructionReport_1 = require("../sport/ReplaceInstructionReport");
class ReplaceExecutionReport extends JsonResponse_1.default {
    constructor(options) {
        super();
        if (this.validateJson(options)) {
            ...
            if (options.instructionReports) {
                this.instructionReports = this.arrayFromJson(options.instructionReports, ReplaceInstructionReport_1.default);
            }
        }
    }
    toJson() {
...
exports.default = ReplaceExecutionReport;
//# sourceMappingURL=ReplaceExecutionReport.js.map