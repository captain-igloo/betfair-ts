...
(function (LoginEndPoint) {
    LoginEndPoint["Cert"] = "https://identitysso-cert.betfair.com/api/certlogin";
...
})(LoginEndPoint || (exports.LoginEndPoint = LoginEndPoint = {}));
const buildUri = (api, method) => {
    return `${API_HOST}/exchange/${api}/rest/v1.0/${method}/`;
};
class ExchangeApi {
    constructor(applicationKey = '', certificateFilename = '', keyFilename = '') {
        this.authToken = '';
