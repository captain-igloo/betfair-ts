...
class CancelExecutionReport extends JsonResponse_1.default {
    constructor(options) {
        super();
        if (this.validateJson(options)) {
            ...
            if (options.instructionReports) {
                this.instructionReports = this.arrayFromJson(options.instructionReports, CancelInstructionReport_1.default);
            }
        }
    }
    toJson() {
...
exports.default = CancelExecutionReport;
//# sourceMappingURL=CancelExecutionReport.js.map