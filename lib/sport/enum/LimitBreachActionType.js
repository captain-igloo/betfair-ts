...
let LimitBreachActionType = /** @class */ (() => {
        ...
        setValue(value) {
            if (value) {
                if (value !== 'REJECT_BETS' &&
                    ...
                    throw new Error(`Invalid LimitBreachActionType: ${value}`);
                }
                this.value = value;
                this.valid = true;
            }
    ...
    return LimitBreachActionType;
})();
exports.default = LimitBreachActionType;
//# sourceMappingURL=LimitBreachActionType.js.map